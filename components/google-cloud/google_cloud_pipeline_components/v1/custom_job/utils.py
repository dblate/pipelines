...
def create_custom_training_job_op_from_component(
  ...
  input_specs[:] = [
      ...
      if input_spec.name not in ('project', 'display_name', 'worker_pool_specs',
                                 'restart_job_on_worker_restart',
                                 'service_account', 'enable_web_access',
  ...
  for input_item in custom_training_job_json['inputs']:
    ...
    if 'restart_job_on_worker_restart' in input_item.values():
      input_item['default'] = restart_job_on_worker_restart
      input_item['optional'] = True
    ...
    if 'enable_web_access' in input_item.values():
      input_item['default'] = enable_web_access
      input_item['optional'] = True
